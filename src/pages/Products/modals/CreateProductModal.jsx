...
const CreateProductModal = ({
    ...
    useEffect(() => {
        if (isOpen && !category_id && !subcategory_id) {
            fetchCategories()
        }
    }, [isOpen])
    ...
    useEffect(() => {
        if (isOpen) {
            const selectedCategoryId = category_id || formData.category_id
            if (selectedCategoryId) {
                fetchSubcategories(selectedCategoryId)
            }
        }
    }, [isOpen, formData.category_id, category_id])
    ...
    const validateForm = () => {
        ...
        if (!category_id && !subcategory_id && !formData.category_id) {
            newErrors.push('Please select a category')
        }

        if ((!category_id && !subcategory_id) && !formData.subcategory_id) {
